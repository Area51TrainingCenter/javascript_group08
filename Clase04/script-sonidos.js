...
var sndRebote, sndColision, sndMusica;
sndRebote = document.createElement("audio");
sndRebote.src = "bounce.wav";
sndColision = document.createElement("audio");
sndColision.src = "coin.wav";
sndMusica = document.createElement("audio");
sndMusica.src = "Pamgaea.mp3";
sndMusica.loop = true;
sndMusica.onloadeddata = function(){
	finJuego = false;
	sndMusica.play();
}
